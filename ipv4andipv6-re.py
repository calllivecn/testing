...
test_ipv4_true = ["1.1.1.1","255.25.2.5","0.0.0.0","1.22.133.244", "192.168.08.3", "192.168.1.238", "192.168.224.170", "192.168.1.11"]

ipv4 = re.compile(r"^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})$")

#ipv4=re.compile(r"^(2[0-5][0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|2[0-4][0-9]|1[0-9]{1,2}|[0-9]{1,2})$")
