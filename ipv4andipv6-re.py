...
test_ipv4_true = ["1.1.1.1","255.25.2.5","0.0.0.0","1.22.133.244"]

#ipv4=re.compile(r"^(2[0-5][0-5]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|1[0-9]{1,2}|[0-9]{1,2})\.(2[0-5][0-5]|[0-9]{1,2}|[0-9]{1,2})$")
