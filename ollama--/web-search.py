...
from ollama import WebFetchResponse, WebSearchResponse, chat, web_fetch, web_search, Client
...
client = Client(host="http://10.1.3.20:11434")
...
while True:
  response = client.chat(model='gemma4:e4b', messages=messages, tools=[web_search, web_fetch], think=True)
